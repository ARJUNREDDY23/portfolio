...
const SocialMediaSection = () => (
  <div className="social-apps-container">
    {socialMediaAppsData.map(socialMediaAppData => (
      <a
        href={socialMediaAppData.siteUrl}
        key={socialMediaAppData.id}
        className="social-anchor"
      >
        <img
          src={socialMediaAppData.imageUrl}
          alt={socialMediaAppData.name}
